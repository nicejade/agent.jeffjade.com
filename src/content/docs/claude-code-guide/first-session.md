...
细节见后续 [CLAUDE.md](/claude-code-guide/claude-md/)；更多命令分类与日常组合见 [Slash 命令](/claude-code-guide/slash-commands/)。
...
下一章：[Slash 命令与常用功能](/claude-code-guide/slash-commands/)——把会话控制面板系统过一遍；再读 [代理循环与工具调用](/claude-code-guide/agent-loop/)，理解命令背后的执行机制。
