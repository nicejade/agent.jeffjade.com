...
| 成本飙升 | [Token 经济学](/claude-code/token-economics/)、[costs 官方](https://code.claude.com/docs/en/costs) |
| 会话跑偏 | [调试与错误恢复](/claude-code/debug-error-recovery/) |
| 权限与沙箱 | [安全边界](/claude-code/security-permissions/) |
| AI 代码审查 | [TDD 与质量](/claude-code/tdd-quality/) |
| 团队规范 | [团队落地](/claude-code/team-organization/) |
